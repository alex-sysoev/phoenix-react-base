defmodule ReactChat.Paginator do
	import Ecto.Query
    ...
    assocs = Map.get(params, :preload, [])

		%Paginator{
			entries: 			entries(query, page_number, @page_size, assocs),
	...
	defp entries(query, page_number, page_size, assocs) do
